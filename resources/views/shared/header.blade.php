...
<body>
    <header class="header text-center">
        ...
        if ($user) { ?>
            <a href='{{ backpack_url('logout') }}' class="btn btn-secondary">Logout</a>
        <?php } else { ?>
            <a href='{{ backpack_url('login') }}' class="btn btn-primary">Login</a>
        <?php }
        ?>
    </header>
    ...
    <div class="main-wrapper">
        ...
        <footer class="footer text-center py-2 theme-bg-dark">
            ...
            <small class="copyright">Designed with <i class="fas fa-heart" style="color: #fb866a;"></i> by Nhom 3 for developers</small>
