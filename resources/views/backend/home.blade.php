        ...
        <div class="row banner">
            ...
            <div class="col-md-12 mt-5">
                ...
                <div class="list-group">
                    ...
                    <div class="list-group-item">
                        <div class="row-content">
                            <h5><i class="fas fa-file-signature mb-3"></i> Manage Articles</h5>
                            <a href="/admin/articles" class="btn btn-info">All articles</a>
                            <a href="/admin/articles/create" class="btn btn-success">Create An Article</a>
                        </div>
                    </div>
                    <div class="list-group-separator"></div>
                    <div class="list-group-item">
